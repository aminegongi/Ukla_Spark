...
class TypeplatController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $typeplats = $em->getRepository('ProjectBundle:Typeplat')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProjectBundle\Form\TypeplatType', $typeplat);
    ...
    {
        $deleteForm = $this->createDeleteForm($typeplat);
        $editForm = $this->createForm('ProjectBundle\Form\TypeplatType', $typeplat);
